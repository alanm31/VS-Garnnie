	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ga':
				...
				animation.addByPrefix('singUP', 'Garnnie Sing note UP0', 24);
				animation.addByPrefix('singUP-alt', 'Garnnie Sing note UP alt', 24);
				animation.addByPrefix('singRIGHT', 'Garnnie Simg Note RIGHT0', 24);
